...
COMPONENT_VERSIONS = {
    ...
    "high_risk_medications": "high_risk_medications:v2",
    "medication_rule_provenance": "medication_rule_provenance:v1",
    "clinical_evidence_registry": "clinical_evidence_registry:v1",
    "confidence_calculator": "v1",
    "citation_validator": "lexical_distance_quality:v2",
    ...
    "vector_db": f"chroma:{settings.CLINICAL_RAG_COLLECTION}",
    "official_clinical_vector_db": f"chroma:{settings.CLINICAL_OFFICIAL_RAG_COLLECTION}",
    "official_clinical_scope": "official_clinical_scope:v1",
    "clinical_rag_source_policy": "rag_source_policy:v1",
